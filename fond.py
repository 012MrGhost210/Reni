...
на 08.08.2025 г.'
   ...
   Строка 133, столбец 0 (A):
      Значение: 'Корректирующая величина, определенная по опционным контрактам, по которым лицо, действующее за счет активов, составляющих инвестиционный портфель, является обязанным лицом'
      Соседние ячейки справа:

   Строка 136, столбец 0 (A):
      Значение: 'Итого корректирующая величина'
      Соседние ячейки справа:

   Строка 141, столбец 0 (A):
      Значение: 'Итого дебиторская задолженность по процентному (купонному) доходу по облигациям'
      Соседние ячейки справа:

   Строка 146, столбец 0 (A):
      Значение: 'Итого прочая дебиторская задолженность'
      Соседние ячейки справа:

   Строка 147, столбец 0 (A):
      Значение: 'Итого дебиторская задолженность (руб.)'
      Соседние ячейки справа:

   Строка 154, столбец 0 (A):
      Значение: 'Итого кредиторская задолженность'
      Соседние ячейки справа:
   ...
   📍 Беру число из столбца: O (индекс 14)
      ✅ Найдено ключевое слово в строке 155, столбец 0
      📍 Значение в столбце 14 (O): ''
      ⚠️ Не удалось преобразовать в число: ''
