...
Найдено .xls файлов: 35

Файл 1 из 35

============================================================
📄 Файл: [2026_01_12]_29.12.2025_СЧА Фонд_ПДС.xls
============================================================
📅 Дата из имени: 29.12.2025
📊 Размер листа: 158 строк x 27 колонок
============================================================
      Первые 15 строк файла:
      ------------------------------------------------------------
      Строка  1: [1]Расчет оценочной стоимости активов и стоимости чис...
      Строка  2: [1]Полное наименование организации, в управлении (дов... | [14]Пенсионные резервы Акционерное 
общество «Негосудар...
      Строка  3: [1]Дата и номер договора доверительного управления
      Строка  5: [1]1. Денежные средства на счетах
      Строка  6: [1]Наименование кредитной организации
      Строка  7: [1]1
      Строка  8: [1]"ГАЗПРОМБАНК" (АКЦИОНЕРНОЕ ОБЩЕСТВО)
      Строка  9: [1]Итого денежных средств на счетах
      Строка 12: [1]2. Денежные средства в депозитах
      Строка 13: [1]Наименование кредитной организации | [11]Название валюты | [15]Сумма вклада (руб.)
      Строка 14: [1]1 | [11]2 | [15]3
      Строка 15: [1]Итого оценочная стоимость депозитов
      Строка 18: [1]3. Депозитные сертификаты
      Строка 19: [1]Наименование кредитной организации | [11]Название валюты | [15]Сумма депозита по сертификату (руб.)
      Строка 20: [1]1 | [11]2 | [15]3
      Строка 21: [1]Итого оценочная стоимость депозитных сертификатов
      Строка 24: [1]4. Государственные ценные бумаги Российской Федера...
      Строка 25: [1]Вид ценных бумаг | [6]Государственный регистрационный номер выпуска (доп... | [12]Цена     
(руб.)
      Строка 26: [1]1 | [6]2 | [12]3
      Строка 27: [1]Итого оценочная стоимость государственных ценных б...
      Строка 29: [1]5. Государственные ценные бумаги Российской Федера...
      Строка 30: [1]Вид ценных бумаг | [10]Государственный регистрационный номер выпуска (доп...

🔍 Найдены упоминания ГАЗПРОМ:
   📍 Строка 8, колонка 1: "ГАЗПРОМБАНК" (АКЦИОНЕРНОЕ ОБЩЕСТВО)

      🔍 НАЙДЕН ГАЗПРОМБАНК в строке 8, колонке 1
      Все значения в строке 8:
        A8: "ГАЗПРОМБАНК" (АКЦИОНЕРНОЕ ОБЩЕСТВО)
        P8: ₽
        X8: 6640689.83

      Найдены числа в строке:
        Колонка 24: 6 640 690

✅ ЗНАЧЕНИЕ НАЙДЕНО: 6 640 690 руб.
